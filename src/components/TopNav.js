  ...
  return (
    <div className="max-w-[1520] mx-auto flex justify-between items-center p-4">
      <div className="flex items-center">
        ...
        <div className="hidden lg:flex items-center bg-gray-200 rounded-full p-3 text-[14px]">
      ...
      <div className="bg-gray-200 rounded-full flex items-center px-2 py-2 w-[170px] sm:w-[400px] lg:w-[500px]">
      ...
      {sideNav ? (
        <div
          className="bg-black/60 fixed w-full h-screen z-10 top-0 right-0"
      ...
      <div
        className={
          sideNav
            ...
            : "fixed top-0 left-[-100%] w-[300px] h-screen bg-blue z-10 duration-1000"
        }
      >
        <AiOutlineClose
          onClick={() => setsideNav(!sideNav)}
